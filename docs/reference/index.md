...
- [`compute_ci(`*`<farrington_model>`*`)`](https://oucru-modelling.github.io/serosv/reference/compute_ci.farrington_model.md)
...
- [`compute_ci(`*`<estimate_from_mixture>`*`)`](https://oucru-modelling.github.io/serosv/reference/compute_ci.estimate_from_mixture.md)
  : Compute confidence interval for the prevalence estimate from mixture
  model
