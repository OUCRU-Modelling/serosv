...
plot(out_pava, facet = TRUE, modtype = "non-monotonized") + coord_cartesian(ylim=c(0, 0.07))
plot(out_pava, facet = TRUE, modtype = "monotonized") + coord_cartesian(ylim=c(0, 0.07))

# Plot without facet
plot(out_pava, facet = FALSE, modtype = "monotonized") + coord_cartesian(ylim=c(0, 0.07))
```

***Example:*** output for model with SCAM for monotonization

```{r warning=FALSE, message=FALSE}
plot(out_scam, facet = TRUE, modtype = "non-monotonized") + coord_cartesian(ylim=c(0, 0.07))
plot(out_scam, facet = TRUE, modtype = "monotonized") + coord_cartesian(ylim=c(0, 0.07))

# Plot CI for FoI
plot(out_scam, facet = TRUE, modtype = "non-monotonized", foi_ci=TRUE) + 
