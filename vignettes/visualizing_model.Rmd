...
If implementation for confidence interval calculation is not yet implemented, `plot` function would simply visualize seroprevalence line
...
For `bivariate_dale_model`, `plot` function would have optional additional arguments for labeling or formatting the plot
