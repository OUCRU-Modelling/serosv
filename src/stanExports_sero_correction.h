...
namespace model_sero_correction_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 21> locations_array__ =
  {" (found before start of program)",
  " (in 'sero_correction', line 9, column 2 to column 31)",
  " (in 'sero_correction', line 10, column 2 to column 31)",
  " (in 'sero_correction', line 11, column 2 to column 36)",
  " (in 'sero_correction', line 14, column 9 to column 13)",
  " (in 'sero_correction', line 14, column 2 to column 30)",
  " (in 'sero_correction', line 16, column 2 to column 48)",
  " (in 'sero_correction', line 17, column 2 to column 48)",
  " (in 'sero_correction', line 20, column 6 to column 28)",
  " (in 'sero_correction', line 22, column 6 to column 68)",
  " (in 'sero_correction', line 23, column 6 to column 51)",
  " (in 'sero_correction', line 19, column 19 to line 24, column 3)",
  " (in 'sero_correction', line 19, column 2 to line 24, column 3)",
  " (in 'sero_correction', line 2, column 2 to column 20)",
  " (in 'sero_correction', line 3, column 2 to column 26)",
  " (in 'sero_correction', line 4, column 2 to column 26)",
  " (in 'sero_correction', line 5, column 20 to column 24)",
  " (in 'sero_correction', line 5, column 2 to column 26)",
  " (in 'sero_correction', line 6, column 18 to column 22)",
  " (in 'sero_correction', line 6, column 2 to column 24)",
  " (in 'sero_correction', line 11, column 30 to column 34)"};
#include <stan_meta_header.hpp>
class model_sero_correction final : public model_base_crtp<model_sero_correction> {
private:
  int Nage;
  double init_se;
  double init_sp;
  ...
  std::vector<int> ni;
public:
  ~model_sero_correction() {}
  model_sero_correction(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_sero_correction_namespace::model_sero_correction";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_sero_correction_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_sero_correction_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_sero_correction_namespace::model_sero_correction;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_sero_correction_namespace::profiles__;
}
#endif
#endif
