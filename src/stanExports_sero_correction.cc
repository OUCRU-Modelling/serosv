...
#include "stanExports_sero_correction.h"

RCPP_MODULE(stan_fit4sero_correction_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_sero_correction")
